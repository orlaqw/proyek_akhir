...
class Container2Dashboard extends StatefulWidget {
  const Container2Dashboard({super.key});

  @override
  State<Container2Dashboard> createState() => _Container2DashboardState();
}

class _Container2DashboardState extends State<Container2Dashboard> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            Align(
                    ...
                    child: Text("Now Showing", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 7, 27, 118),
                          ),
                        ),
                    ),
                  ),
